...
register(
    ...
    viewclass="EventView",
    order=START,
    help_url = "Gramps_5.2_Wiki_Manual_-_Categories#Events_View",
)
...
register(
    ...
    order=START,
    help_url = "Gramps_5.2_Wiki_Manual_-_Categories#Families_Category",
)
...
register(
    ...
    order=START,
    help_url = "Gramps_5.2_Wiki_Manual_-_Categories#Dashboard_Category",
)
...
register(
    ...
    viewclass="MediaView",
    order=START,
    help_url = "Gramps_5.2_Wiki_Manual_-_Categories#Media_List_View",
)
...
register(
    ...
    viewclass="NoteView",
    order=START,
    help_url = "Gramps_5.2_Wiki_Manual_-_Categories#Notes_List_View",
)
...
register(
    ...
    order=START,
    help_url = "Gramps_5.2_Wiki_Manual_-_Categories#Relationships_Category_view",
)
...
register(
    ...
    help_url = "Gramps_5.2_Wiki_Manual_-_Categories#Pedigree_View",
)
...
register(
    ...
    help_url = "Gramps_5.2_Wiki_Manual_-_Categories#Fan_Chart_View",
)
...
register(
    ...
    help_url = "Gramps_5.2_Wiki_Manual_-_Categories#Descendant_Fan_View",
)
...
register(
    ...
    help_url = "Gramps_5.2_Wiki_Manual_-_Categories#2-Way_Fan_View",
)
...
register(
    ...
    help_url = "Gramps_5.2_Wiki_Manual_-_Categories#Tree_View_-_Grouped_People",
)
...
register(
    ...
    help_url = "Gramps_5.2_Wiki_Manual_-_Categories#People_List_View",
)
...
register(
    ...
    stock_icon="gramps-tree-list",
    help_url = "Gramps_5.2_Wiki_Manual_-_Categories#Places_List_View",
)
...
register(
    ...
    stock_icon="gramps-tree-group",
    order=START,
    help_url = "Gramps_5.2_Wiki_Manual_-_Categories#Places_Tree_View",
)
...
register(
    ...
    order=START,
    help_url = "Gramps_5.2_Wiki_Manual_-_Categories#Repository_List_View",
)
...
register(
    ...
    order=START,
    stock_icon="gramps-tree-list",
    help_url = "Gramps_5.2_Wiki_Manual_-_Categories#Sources_List_View",
)
...
register(
    ...
    order=START,
    help_url = "Gramps_5.2_Wiki_Manual_-_Categories#Citations_List_View",
)
...
register(
    ...
    help_url = "Gramps_5.2_Wiki_Manual_-_Categories#Citation_Tree_View",
)
